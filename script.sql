...
values(1, 'Tokyo Ghoul', 'Teuku Miadora')

insert into livros (id_livros, titulo, autor)
values(2, 'Harry Potter', 'J.K Rowling')

insert into livros (id_livros, titulo, autor)
values(3, 'My Hero Academia', 'Kohei Horikoshi')

insert into livros (id_livros, titulo, autor)
values(4, 'Jujutsu Kaisen', 'Gege Akutami')
...
insert into livros (id_livros, titulo, autor)
values(7, 'One Piece', 'Eichiro Oda')

insert into livros (id_livros, titulo, autor)
values(8, 'Dragon Ball', 'Akira Toriyama')

insert into livros (id_livros, titulo, autor)
values(9, 'Your Name', 'Makoto Shinkai')

insert into livros (id_livros, titulo, autor)
values(10, 'Katekyo Hitman Reborn', 'Akira Amano')
